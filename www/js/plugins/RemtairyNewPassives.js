...
const CHARA_CREATE_TWO_PETTING_ID = 997;
...
Game_Actor.prototype.checkForNewSpecialPassives = function() {
	...
	if(!this.hasPassive(PASSIVE_KICK_COUNTER_SEX_COUNT_ONE_ID) && this._recordSexPose_KickCounterCount > 0) {
		this.learnNewPassive(PASSIVE_KICK_COUNTER_SEX_COUNT_ONE_ID)
	}
	else if(!this.hasPassive(PASSIVE_KICK_COUNTER_SEX_COUNT_TWO_ID) && this._recordSexPose_KickCounterCount >= 10) {
		this.learnNewPassive(PASSIVE_KICK_COUNTER_SEX_COUNT_TWO_ID)
	}
	else if(!this.hasPassive(PASSIVE_KICK_COUNTER_SEX_COUNT_THREE_ID) && this._recordSexPose_KickCounterCount >= 42) {
	...
	if(!this.hasPassive(PASSIVE_TRIPLE_PEN_COUNT_ONE_ID) && this._recordTriplePenetrationCount > 0) {
	...
	else if(!this.hasPassive(PASSIVE_BAR_WAITRESS_SEX_COUNT_TWO_ID) && this._recordBarWaitressSexCount >= 10) {
		this.learnNewPassive(PASSIVE_BAR_WAITRESS_SEX_COUNT_TWO_ID)
	}
	else if(!this.hasPassive(PASSIVE_BAR_WAITRESS_SEX_COUNT_THREE_ID) && this._recordBarWaitressSexCount >= 30) {
...
Game_Actor.prototype.checkForNewSadoMasoPassives = function() {
	...
	else if(!this.hasPassive(PASSIVE_COCKKICK_COUNT_TWO_ID) && this._recordCockKickUsageCount >= 25 && this._recordCockinessGainedValue >= 500) {
		this.learnNewPassive(PASSIVE_COCKKICK_COUNT_TWO_ID)
	}
	else if(!this.hasPassive(PASSIVE_COCKKICK_COUNT_THREE_ID) && this._recordCockKickUsageCount >= 75 && this._recordCockinessGainedValue >= 1500) {
...
Game_Actor.prototype.checkForNewDebuffPassives = function() {
	...
	if(!this.hasPassive(PASSIVE_OFFBALANCE_COUNT_ONE_ID) && this._recordDebuffOffBalancedCount >= 10 && this._recordDefeatedTotal >= 3) {
		this.learnNewPassive(PASSIVE_OFFBALANCE_COUNT_ONE_ID)
	}
	else if(!this.hasPassive(PASSIVE_OFFBALANCE_COUNT_TWO_ID) && this._recordDebuffOffBalancedCount >= 20 && this._recordDefeatedTotal >= 10) {
		this.learnNewPassive(PASSIVE_OFFBALANCE_COUNT_TWO_ID)
	}
	else if(!this.hasPassive(PASSIVE_OFFBALANCE_COUNT_THREE_ID) && this._recordDebuffOffBalancedCount >= 42 && this._recordDefeatedTotal >= 30) {
...
Game_Actor.prototype.checkForNewSexualPartnersPassives = function() {
	...
	else if(!this.hasPassive(PASSIVE_SEXUAL_PARTNERS_LIZARDMAN_TWO_ID) && this._recordSexualPartnersLizardman >= 20) {
		this.learnNewPassive(PASSIVE_SEXUAL_PARTNERS_LIZARDMAN_TWO_ID)
	}
	else if(!this.hasPassive(PASSIVE_SEXUAL_PARTNERS_LIZARDMAN_THREE_ID) && this._recordSexualPartnersLizardman >= 100) {
	...
	else if(!this.hasPassive(PASSIVE_SEXUAL_PARTNERS_ORC_TWO_ID) && this._recordSexualPartnersOrc >= 20) {
		this.learnNewPassive(PASSIVE_SEXUAL_PARTNERS_ORC_TWO_ID)
	}
	else if(!this.hasPassive(PASSIVE_SEXUAL_PARTNERS_ORC_THREE_ID) && this._recordSexualPartnersOrc >= 100) {
	...
	else if(!this.hasPassive(PASSIVE_SEXUAL_PARTNERS_HOMELESS_TWO_ID) && this._recordSexualPartnersHomeless >= 20) {
		this.learnNewPassive(PASSIVE_SEXUAL_PARTNERS_HOMELESS_TWO_ID)
	}
	else if(!this.hasPassive(PASSIVE_SEXUAL_PARTNERS_HOMELESS_THREE_ID) && this._recordSexualPartnersHomeless >= 100) {
	...
	else if(!this.hasPassive(PASSIVE_RECEPTIONIST_VISITOR_SEX_COUNT_TWO_ID) && this._recordSexualPartnersVisitor >= 10) {
		this.learnNewPassive(PASSIVE_RECEPTIONIST_VISITOR_SEX_COUNT_TWO_ID)
	}
	else if(!this.hasPassive(PASSIVE_RECEPTIONIST_VISITOR_SEX_COUNT_THREE_ID) && this._recordSexualPartnersVisitor >= 30) {
