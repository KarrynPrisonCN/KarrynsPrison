...
POSESMAP.get(POSE_SLIME_PILEDRIVER_ANAL)[POSE_MAP_TIER_ID] = POSE_MAP_TIER_TWO_ID;
...
POSESMAP.get(POSE_KARRYN_COWGIRL)[POSE_MAP_TIER_ID] = POSE_MAP_TIER_THREE_ID;
...
POSESMAP.get(POSE_REVERSE_COWGIRL)[POSE_MAP_TIER_ID] = POSE_MAP_TIER_THREE_ID;
...
Game_Actor.prototype.getCurrentPoseTier = function() {
	return this.getPoseTierFromPoseName(this.poseName);
};
